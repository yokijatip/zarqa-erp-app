...
fun LoginScreen(
    ...
    // Navigasi ke WorkerActivity setelah login sukses
    LaunchedEffect(uiState.loggedInProfile) {
        val profile = uiState.loggedInProfile ?: return@LaunchedEffect
